...
from ANN.models.wav2vec2.efficientEncoder import fastWav2Vec2Encoder,fastWav2Vec2EncoderStableLayerNorm
from ANN.models.wav2vec2.correctedEncoder import robustWav2Vec2FeatureEncoder
...
class pierreWav2Vec2Model(Wav2Vec2PreTrainedModel):
    def __init__(self, config: Wav2Vec2Config):
        ...
        self.config = config
        self.feature_extractor = robustWav2Vec2FeatureEncoder(config)
        ...
        if config.do_stable_layer_norm:
            self.encoder = fastWav2Vec2EncoderStableLayerNorm(config)
        else:
            self.encoder = fastWav2Vec2Encoder(config)
...
class Wav2Vec2ForPreTraining_latentMask(Wav2Vec2PreTrainedModel):
    def __init__(self, config: Wav2Vec2Config):
        super().__init__(config)
